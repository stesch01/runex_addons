$(document).ready(function () {
    if(! $(".oe_website_sale #products_grid").length){
        return;
    }

$('.oe_website_sale').each(function () {

//    FIX: There is no js_add_cart_variants in popup,
//    so prevent action if no js_add_cart_variants class found
...
$('.oe_website_sale #products_grid .product_price a')
.off('click')
